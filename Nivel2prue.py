...
if __name__ == '__main__':
    ...
    font2 = pygame.font.Font('fuente/zombie.otf', 30)
    conniv2 = font2.render("Press 'ENTER' to continue...", True, BLANCO)
    ...
    while not fin:
        if NIVEL2 == True:
            ...
            fondo = pygame.image.load("imagen/fondo2.png").convert()
            pantalla.blit(fondo, (0, 0))
            ...
            rick2=pygame.image.load('imagen/Rick(1).png').convert_alpha()
            pantalla.blit(rick2,(1216,512))
            pygame.display.flip()

            jp=Jugador('imagen/RickBox.png',1216,512)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_p:
                    if PAUSE == False and (WIN1== False or WIN2 == False) and GAMEOVER== False:
                        jp.SonidoPA()
                        PAUSE = True
                    else:
                        if PAUSE == True:
                ...
                if event.key == pygame.K_RETURN:
                    if ENT==True and WIN1 == True and NumNivel2 == False:
                        NIVEL2 = True
                        ENT=False
        ...
        if PAUSE==False:
            if WIN1 == True and ENT == False:
                jp.sonidoz.stop()
                jp.sonidom.stop()
                #pantalla.blit(you, [322, 160])
                pantalla.blit(conniv2, [450, 416])
                ENT=True
            if WIN2 == True:
                jp.sonidoz.stop()
                jp.sonidom.stop()
            ...
            if NumNivel1 ==True and WIN1==False:
                fondo = pygame.image.load("imagen/gris1.png").convert()
                pantalla.blit(fondo, (0, 0))
                ...
                todos.draw(pantalla)
                pygame.display.flip()
            if NumNivel2 == True and WIN2==False:
                fondo = pygame.image.load("imagen/fondo2.png").convert()
                pantalla.blit(fondo, (0, 0))
                pantalla.blit(lif, [160, 576])
                pantalla.blit(ap, [32, 192])
